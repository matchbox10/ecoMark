...
To use these stylesheets, rename the files and omega_eco with the name of your theme.
...
omega_eco-alpha-default-narrow.css  
...
omega_eco-alpha-default-normal.css
...
omega_eco-alpha-default-wide.css
